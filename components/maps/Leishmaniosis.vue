...
import map_data from '@/composables/map-leishmaniosis.js'
				...
				<div class="map-data">
					<div v-if="!showing_info" 
						...
						<div class="flex-1 md:text-sm lg:text-2xl">
							...
							prevalencia de la leishmaniosis en esta región.
						</div>
					</div>
...
@media (min-width: 768px){
	...
	.map-section{
		background: linear-gradient(90deg, rgba(0,114,206,1) 25%, rgba(243,243,243,1) 25%);
	}
...
@media (min-width: 2300px){
	...
	.map-section{
		background: linear-gradient(90deg, rgba(0,114,206,1) 35%, rgba(243,243,243,1) 35%);
	}
