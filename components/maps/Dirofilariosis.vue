...
import map_data from '@/composables/map-dirofilariosis.js'
			...
			<div class="md:col-span-4 lg:col-span-3">
				<div class="map-data">
					<div v-if="!showing_info"
						...
						<div class="flex-1 md:text-sm lg:text-2xl">
							Selecciona una zona del mapa y descubre la 
							prevalencia de la dirofilariosis en esta región.
						</div>
...
<style scoped>
.map-data{
	@apply bg-brand-orange text-white text-sm leading-tight 
...
.map-section{ @apply bg-brand-orange; }


@media (min-width: 768px){

	.map-section{
		background: linear-gradient(90deg, rgba(237,131,37,1) 25%, rgba(243,243,243,1) 25%);
	}
...
@media (min-width: 2300px){
	...
	.map-section{
		background: linear-gradient(90deg, rgba(237,131,37,1) 35%, rgba(243,243,243,1) 35%);
	}
